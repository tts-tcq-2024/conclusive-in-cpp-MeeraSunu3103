...
**using simple functions with low cyclomatic and cognitive complexity as much as possible, avoiding duplication as much as possible, proper naming of variables and testcases to increase readability, usage of appropriate comments to enhance readability of the code, proper and exact scoping of requirements, test-based development (wherever possible) to cover all requirements and possible failures, etc.**
